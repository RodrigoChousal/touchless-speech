...
class CardViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
	...
	func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
		if collectionView == self.cardCollectionView {
			...
			let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "SelectedWordCell", for: indexPath) as! CardCollectionViewCell
	...
	func makeButtonsPretty() {
		...
		backButton.layer.borderColor = (UIColor(red: 41/255, green: 128/255, blue: 185/255, alpha: 1.0) as! CGColor)
		...
		nextButton.layer.borderColor = (UIColor(red: 41/255, green: 128/255, blue: 185/255, alpha: 1.0) as! CGColor)
		...
		homeButton.layer.borderColor = (UIColor(red: 39/255, green: 174/255, blue: 96/255, alpha: 1.0) as! CGColor)
		...
		sayButton.layer.borderColor = (UIColor(red: 39/255, green: 174/255, blue: 96/255, alpha: 1.0) as! CGColor)
		...
		deleteButton.layer.borderColor = (UIColor(red: 192/255, green: 57/255, blue: 43/255, alpha: 1.0) as! CGColor)
